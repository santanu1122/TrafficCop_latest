...
- (void)initLayers
{
    ...
    for (int i = 0; i < kActivityIndicatorDotNumber; i++)
    {
        ...
        dotLayer.frame = CGRectMake(-2.0f, 5.0f, 5.0f, 5.0f);
        
        switch (i) {
            case 0:
                dotLayer.backgroundColor = UIColorFromRGB(0xde1d23).CGColor;
                break;
            case 1:
                dotLayer.backgroundColor = UIColorFromRGB(0xfcb714).CGColor;
                break;
            case 2:
                dotLayer.backgroundColor = UIColorFromRGB(0x1aad4b).CGColor;
                break;
            case 3:
                dotLayer.backgroundColor = UIColorFromRGB(0xde1d23).CGColor;
                break;
