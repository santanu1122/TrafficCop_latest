...

{
   ...
   // UserDetailesViewController *viewControl;
...

{
    ...
    UIImageView *image=[[UIImageView alloc]initWithFrame:CGRectMake(Xcord, Ycord, Width, Height)];
    
    
    
    image.image=[UIImage imageNamed:ImageForUIControlStateNormal];
    ...
    Recutng.frame = CGRectMake(Xcord-10, Ycord-5, Width+10, Height+5);
    ...
    [Recutng setBackgroundColor:[UIColor clearColor]];
...
-(void)CreateButtonWithValueX: (float)Xcord ycord:(float)Ycord width:(float)Width height:(float)Height backgroundColor:(UIColor *)Color textcolor:(UIColor *)Textcolor labeltext:(NSString *)LabelText fontName:(NSString *)FontName fontSize:(Size)FontSize imageNameForUIControlStateNormal:(NSString *)ImageForUIControlStateNormal imageNameForUIControlStateSelected:(NSString *)ImageForUIControlStateSelected imageNameForUIControlStateHighlighted:(NSString *)ImageForUIControlStateHighlighted imageNameForselectedHighlighted:(NSString *)ImageForselectedHighlighted selectMethod:(SEL)SelectMethod selectEvent:(UIControlEvents)SelectEvent addView:(UIView *)AddToView viewController:(UIViewController *)ViewController
...

{
    ...
    [Recutng addTarget:self action:@selector(backButtonPressedX:) forControlEvents:UIControlEventTouchUpInside];
...

{
    ...
    TextFieldName.font = [UIFont fontWithName:GLOBALTEXTFONT size:FontSize];
...
-(void)SetupHeaderViewWithCustomButton:(UIView *)AddToView viewController:(UIViewController *)ViewController hideLeftButton:(BOOL)hideLeftButton hiderightButton:(BOOL)hiderightButton leftButtonCustom:(BOOL)leftButtonCustom rightButtonCustom:(BOOL)rightButtonCustom leftButtonText:(NSString *)leftButtonText rightButtonText:(NSString *)rightButtonText LeftButtonImgae:(NSString *)LeftButtonImgae RightButtonImgae:(NSString *)RightButtonImgae LeftButtonMethod:(SEL)LeftButtonMethod RightButtonMethod:(SEL)RightButtonMethod {
    ...
    [self CreateButtonWithValue:10 ycord:20 width:30 height:30 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"menu.png" imageNameForUIControlStateSelected:@"menu.png" imageNameForUIControlStateHighlighted:@"menu.png" imageNameForselectedHighlighted:@"menu.png" selectMethod:@selector(leftSideMenuButtonPressed:) selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
    
    
    
    [self CreateButtonWithValue:0 ycord:10 width:50 height:50 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"" imageNameForUIControlStateSelected:@"" imageNameForUIControlStateHighlighted:@"" imageNameForselectedHighlighted:@"" selectMethod:@selector(leftSideMenuButtonPressed:) selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
    ...
    [self CreateButtonWithValue:283 ycord:18 width:26 height:26 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"DELETE" imageNameForUIControlStateSelected:@"DELETE" imageNameForUIControlStateHighlighted:@"DELETE" imageNameForselectedHighlighted:@"DELETE" selectMethod:RightButtonMethod selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
    
    
    
    [self CreateButtonWithValue:275 ycord:0 width:50 height:50 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"" imageNameForUIControlStateSelected:@"" imageNameForUIControlStateHighlighted:@"" imageNameForselectedHighlighted:@"" selectMethod:RightButtonMethod selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
...
-(void)SetupHeaderViewForReport:(UIView *)AddToView viewController:(UIViewController *)ViewController {
    ...
    UILabel *greenLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 320/3,2)];
    ...
    UILabel *yellowlabel = [[UILabel alloc] initWithFrame:CGRectMake(320/3, 0, 320/3,2)];
    ...
    UILabel *redlabel = [[UILabel alloc] initWithFrame:CGRectMake(320/3*2, 0, 320/3+5,2)];
...
-(void)SetupHeaderView:(UIView *)AddToView viewController:(UIViewController *)ViewController {
    ...
    [self CreateButtonWithValue:10 ycord:15 width:30 height:30 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"menu.png" imageNameForUIControlStateSelected:@"menu.png" imageNameForUIControlStateHighlighted:@"menu.png" imageNameForselectedHighlighted:@"menu.png" selectMethod:@selector(leftSideMenuButtonPressed:) selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
    ...
    [self CreateButtonWithValue:283 ycord:18 width:26 height:26 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"settings 2.png" imageNameForUIControlStateSelected:@"settings 2.png" imageNameForUIControlStateHighlighted:@"settings 2.png" imageNameForselectedHighlighted:@"settings 2.png" selectMethod:@selector(rightSideMenuButtonPressed:) selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
...
-(void)SetupHeaderViewWithBack:(UIView *)AddToView viewController:(UIViewController *)ViewController {
   ...
   // viewControl=(UserDetailesViewController *)ViewController;
    ...
    [self CreateButtonWithValueX:10 ycord:15 width:30 height:30 backgroundColor:[UIColor clearColor] textcolor:[UIColor clearColor] labeltext:Nil fontName:Nil fontSize:0 imageNameForUIControlStateNormal:@"arrow-left.png" imageNameForUIControlStateSelected:@"arrow-left.png" imageNameForUIControlStateHighlighted:@"arrow-left.png" imageNameForselectedHighlighted:@"arrow-left.png" selectMethod:@selector(backButtonPressed:) selectEvent:UIControlEventTouchUpInside addView:HeaderView viewController:ViewController];
...

{
    ...
    //    LayoutVew =[[UIView alloc] initWithFrame:CGRectMake(50, Height/2, Width-100, 80)];
    
    //    LayoutVew.backgroundColor = [UIColor whiteColor];
    
    //    LayoutVew.layer.opacity = OpacitY;
    
    //    LayoutVew.layer.cornerRadius = 5;
    
    //    LayoutVew.layer.masksToBounds = YES;
    
    //
    
    //    UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(0, 10, LayoutVew.frame.size.width, 30)];
    
    //    label.text=@"Please Wait";
    
    //    label.textAlignment=NSTextAlignmentCenter;
    
    //    UIActivityIndicatorView *indicatorView=[[UIActivityIndicatorView alloc]initWithFrame:CGRectMake(LayoutVew.center.x/2, 45, 30, 30)];
    
    //    indicatorView.activityIndicatorViewStyle = UIActivityIndicatorViewStyleGray;
    
    //    [LayoutVew addSubview:indicatorView];
    
    //    [indicatorView startAnimating];
    
    //    [LayoutVew addSubview:label];
    
    //    [MainView addSubview:LayoutVew];
    
    NSLog(@"This is fired for menu event");
    ...
    //    UILabel *greenLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 320/3,3)];
    ...
    //    UILabel *yellowlabel = [[UILabel alloc] initWithFrame:CGRectMake(320/3, 0, 320/3,3)];
    ...
    //    UILabel *redlabel = [[UILabel alloc] initWithFrame:CGRectMake(320/3*2, 0, 320/3+5,3)];
    ...
    //    UILabel *greenLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(0, Height-3, 320/3,3)];
    ...
    //    UILabel *yellowlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(320/3, Height-2, 320/3,3)];
    ...
    //    UILabel *redlabel1 = [[UILabel alloc] initWithFrame:CGRectMake(320/3*2, Height-2, 320/3+5,3)];
...
-(void)setTopView:(UIView *)view{
    ...
    UIView *HeaderView=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 1.5)];
...
-(void) backButtonPressedX:(id)sender{
    
    AppDelegate *appd=(AppDelegate *)[[UIApplication sharedApplication]delegate];
    [appd.navigationController popViewControllerAnimated:YES ];
   // [viewControl setBack];
